...
<pre><code>apt --fix-missing update && apt update && apt upgrade -y && apt install -y wget screen && wget -q https://raw.githubusercontent.com/SETANTAZVPN/vvip/ipuk/install.sh && chmod +x install.sh && screen -S install ./install.sh</code></pre>
